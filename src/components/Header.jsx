...
const Header = () => {
    ...
    return (
        <div className="bg-[url('/src/assets/image.png')] bg-cover bg-center bg-no-repeat h-screen mt-8 rounded-3xl flex flex-col items-center justify-center text-white lg:px-48 md:px-24 px-8 space-y-8">
